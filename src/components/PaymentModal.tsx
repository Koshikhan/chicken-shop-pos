      ...
      <section className="max-h-[95vh] w-full max-w-3xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        {isPaid ? (
          <div className="p-8 text-center">
            ...
            <div className="mx-auto mt-4 inline-flex rounded-full bg-orange-100 px-4 py-2 text-sm font-black text-orange-700">
              {taxType === "VAT"
                ? `VAT Sale · ${vatPercentage}%`
                : "Non-VAT Sale"}
            </div>
            ...
            <div className="mx-auto mt-7 max-w-lg space-y-3 rounded-2xl bg-slate-100 p-5 text-left">
              ...
              <div className="flex justify-between border-t border-slate-300 pt-3 text-xl font-black text-slate-950">
                <span>
                  Order total
                </span>
          ...
          <>
            <header className="flex items-start justify-between border-b border-slate-200 p-6">
              <div>
                ...
                <span className="mt-3 inline-flex rounded-full bg-orange-100 px-3 py-1 text-xs font-black text-orange-700">
                  {taxType === "VAT"
                    ? `VAT Sale · ${vatPercentage}%`
                    : "Non-VAT Sale"}
                </span>
