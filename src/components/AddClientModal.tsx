...
const TEMPLATE_OPTIONS: {
...
}[] = [
  {
    ...
    label:
      "Fast Food",
    description:
      "Counter service, meals, burgers, wraps and quick checkout.",
  },
  {
    value:
      "DELI",
    label:
      "Deli",
    description:
      "Sandwiches, baguettes, paninis and counter customisation.",
  },
  {
    value:
      "RESTAURANT",
    label:
      "Restaurant",
    description:
      "Restaurant menu structure. Table features can be expanded later.",
  },
  {
    value:
      "RETAIL",
    label:
      "Retail",
    description:
      "General retail products, inventory and checkout.",
  },
];
      ...
      <section className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        ...
        >
          ...
          <div className="rounded-2xl bg-slate-50 p-4 text-sm leading-6 text-slate-600">
            The client cannot
            choose or change the
            business template.
            Template changes stay
            under KAY POS
            platform control.
          </div>
          ...
          >
            {isSaving
              ? "Creating client and sending invitation..."
